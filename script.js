document.addEventListener("DOMContentLoaded", function () {
  ...
  const questions = [
    ...
    },
    {
      ...
      category: "basic",
      question:
        "Write a query to retrieve all records from a table named employees.",
      code: null,
      answer:
        "SELECT * FROM employees;<br><br> This query selects and displays all columns and rows from the employees table.",
    },
    ...
    },
    {
      ...
      code: null,
      answer:
        "SELECT MAX(salary) FROM employees; <br><br>This query returns the highest salary from the employees table.",
    },
    {
      id: 8,
      category: "basic",
      ...
      code: null,
      answer:
        "SELECT MAX(salary) FROM employees\n WHERE salary < (SELECT MAX(salary) FROM employees);<br><br>The subquery finds the maximum salary, and the outer query finds the highest salary that is less than that value (i.e., the second-highest salary).",
    },
    {
      id: 9,
      category: "basic",
    ...
    },
    {
      ...
      category: "joins",
      question:
        "Write a query to fetch employee names and department names using JOIN.",
      code: null,
      answer:
        "SELECT e.name, d.department_name\nFROM employees e\nJOIN departments d\nON e.department_id = d.id;<br> <br>This query joins the employees table with the departments table based on the department_id, displaying employee names and their corresponding department names.",
    },
    {
      id: 11,
      category: "basic",
      ...
      code: null,
      answer:
        "The GROUP BY clause groups rows with the same values into summary rows. It is commonly used with aggregate functions like COUNT(), SUM(), AVG(), etc.",
    },
    {
      id: 12,
      category: "basic",
      ...
      code: null,
      answer:
        "SELECT department_id, COUNT(*) FROM employees GROUP BY department_id;<br><br>This query groups employees by department_id and counts the number of employees in each department.",
    },
    {
      id: 13,
      category: "basic",
      ...
      code: null,
      answer:
        "<ul><li><span class='sql-keyword'>WHERE</span>: Filters rows before grouping (applies to individual rows).</li><li><span class='sql-keyword'>HAVING</span>: Filters groups after the GROUP BY clause (applies to aggregate functions).</li></ul>",
    },
    {
      id: 14,
      category: "basic",
      question:
        "Write a query to fetch departments with more than 5 employees.",
      code: null,
      answer:
        "SELECT department_id, COUNT(*) FROM employees GROUP BY department_id HAVING COUNT(*) > 5;<br><br>The query counts employees in each department and returns departments with more than 5 employees.",
    },
    {
      id: 15,
      category: "basic",
      ...
      code: null,
      answer:
        "<ul><li><span class='sql-keyword'>UNION</span>: Combines results of two or more SELECT statements and removes duplicates.</li><li><span class='sql-keyword'>UNION ALL</span>: Combines results and keeps all duplicates.</li></ul>",
    },
    {
      id: 16,
      category: "basic",
      ...
      code: null,
      answer:
        "A subquery is a query nested within another query. It is used to retrieve data that will be passed into the outer query.",
    },
    {
      id: 17,
      category: "basic",
      ...
      code: null,
      answer:
        "SELECT * FROM employees WHERE salary > (SELECT AVG(salary) FROM employees);<br><br>This query selects all employees with a salary higher than the average salary of all employees.",
    },
    {
      id: 18,
      category: "joins",
      ...
      code: null,
      answer:
        "<ul><li><span class='sql-keyword'>INNER JOIN</span>: Returns rows with matching values in both tables.</li><li><span class='sql-keyword'>OUTER JOIN</span> (Left/Right/Full): Returns matching rows plus non-matching rows from one or both tables.</li></ul>",
    },
    {
      id: 19,
      category: "basic",
      ...
      code: null,
      answer:
        "SELECT CURRENT_DATE;<br><br>This query retrieves the current date from the database.",
    },
    {
      id: 20,
      category: "basic",
      ...
      code: null,
      answer:
        "Indexing improves the speed of data retrieval by creating a data structure (index) on one or more columns of a table.",
    },
    {
      id: 21,
      category: "basic",
      question:
        "What is normalization? Explain its types (1NF, 2NF, 3NF, BCNF).",
      code: null,
      answer:
    ...
    },
    {
      ...
      code: null,
      answer:
        "Denormalization is the process of combining normalized tables to improve performance at the cost of introducing redundancy.",
    },
    {
      id: 23,
      category: "basic",
      ...
      code: null,
      answer:
        "ALTER TABLE employees ADD COLUMN email VARCHAR(255);<br><br>This query adds a new email column to the employees table.",
    },
    {
      id: 24,
      category: "basic",
      ...
      code: null,
      answer:
        "A stored procedure is a set of SQL statements that can be stored in the database and executed as a program to perform a specific task.",
    },
    {
      id: 25,
      category: "basic",
      ...
      code: null,
      answer:
        "CREATE PROCEDURE GetAllEmployees()<br>BEGIN<br>  SELECT * FROM employees;<br>END;<br><br>This procedure retrieves all records from the employees table when executed.",
    },
    {
      id: 26,
      category: "basic",
      ...
      code: null,
      answer:
        'Triggers are special procedures that are automatically executed (or "triggered") in response to certain events (INSERT, UPDATE, DELETE) on a table.',
    },
    {
      id: 27,
      category: "advanced",
      question:
        "Write a query to create a trigger that logs any delete action on the employees table.",
      code: null,
      answer:
        "CREATE TRIGGER log_delete<br>AFTER DELETE ON employees<br>FOR EACH ROW<br>BEGIN<br>  INSERT INTO log_table(action, emp_id, log_time)<br>  VALUES('DELETE', OLD.id, NOW());<br>END;<br><br>This trigger logs the deletion of any employee by recording the action and employee ID in the log_table.",
    },
    {
      id: 28,
      category: "basic",
      ...
      code: null,
      answer:
        "A VIEW is a virtual table based on the result set of an SQL query. It does not store the data itself but provides a way to simplify complex queries.",
    },
    {
      id: 29,
      category: "basic",
      question:
        "Write a query to create a view for employees with salary greater than 50,000.",
      code: null,
      answer:
        "CREATE VIEW HighSalaryEmployees AS SELECT * FROM employees WHERE salary > 50000;<br><br>This query creates a view that shows only employees with salaries above $50,000.",
    },
    {
      id: 30,
      category: "basic",
      ...
      code: null,
      answer:
        "A TABLE stores data physically, while a VIEW is a virtual representation that dynamically pulls data from one or more tables without storing it.",
    },
    {
      id: 31,
    ...
    },
    {
      ...
      code: null,
      answer:
        "SELECT department_id, SUM(salary) FROM employees GROUP BY department_id;<br><br>This query sums the salaries for each department, grouping by department_id.",
    },
    {
      id: 33,
      category: "basic",
    ...
    },
    {
      ...
      category: "basic",
      question:
        "Write a query to find distinct job titles from the employees table.",
      code: null,
      answer:
        "SELECT DISTINCT job_title FROM employees;<br><br>This query retrieves unique job titles from the employees table.",
    },
    {
      id: 35,
      category: "advanced",
    ...
    },
    {
      ...
      category: "advanced",
      question:
        "Write a query to start a transaction, update a record, and commit it.",
      code: null,
      answer:
        "START TRANSACTION;\nUPDATE employees SET salary = 60000 WHERE id = 1;\nCOMMIT;<br><br>This sequence starts a transaction, updates an employee's salary, and commits the change.",
    },
    {
      id: 39,
      category: "advanced",
    ...
    },
    {
      ...
      code: null,
      answer:
        "SELECT name,\n    CASE\n        WHEN salary > 50000 THEN 'High'\n        WHEN salary BETWEEN 30000 AND 50000 THEN 'Medium'\n        ELSE 'Low'\n    END AS salary_category\nFROM employees;<br><br>This query categorizes employees based on their salary levels.",
    },
    {
      id: 41,
      category: "basic",
    ...
    },
    {
      ...
      code: null,
      answer:
        "SELECT * FROM employees WHERE email IS NULL;<br><br>This query retrieves all employees whose email address is not provided (i.e., is NULL).",
    },
    {
      id: 43,
      category: "advanced",
    ...
    },
    {
      ...
      category: "advanced",
      question:
        "Write a query using COALESCE to handle NULL values in a column.",
      code: null,
      answer:
        "SELECT name, COALESCE(email, 'No Email') AS email_address\nFROM employees;<br><br>This query replaces NULL email values with the string 'No Email'.",
    },
    {
      id: 45,
      category: "aggregation",
    ...
    },
    {
      ...
      category: "basic",
      question:
        "Write a query to update an employee's salary by 10% where the salary is below 30,000.",
      code: null,
      answer:
        "UPDATE employees\nSET salary = salary * 1.10\nWHERE salary < 30000;<br><br>This query increases the salary of employees earning less than 30,000 by 10%.",
    },
    {
      id: 48,
      category: "advanced",
    ...
    },
    {
      ...
      category: "advanced",
      question:
        "Write a recursive query to get a hierarchical structure of employees and their managers.",
      code: null,
      answer:
        "WITH RECURSIVE EmployeeHierarchy AS (\n    SELECT id, name, manager_id\n    FROM employees\n    WHERE manager_id IS NULL\n    UNION ALL\n    SELECT e.id, e.name, e.manager_id\n    FROM employees e\n    INNER JOIN EmployeeHierarchy eh\n    ON e.manager_id = eh.id\n)\nSELECT * FROM EmployeeHierarchy;<br><br>This recursive query generates a hierarchy of employees based on their managers.",
    },
    {
      id: 50,
      category: "advanced",
    ...
    },
    {
      ...
      category: "basic",
      question:
        "Write a query to retrieve the top 5 highest salaries from the employees table.",
      code: null,
      answer:
        "SELECT DISTINCT salary\nFROM employees\nORDER BY salary DESC\nLIMIT 5;<br><br>This query selects the top 5 unique highest salaries from the employees table.",
    },
    {
      id: 53,
      category: "basic",
    ...
    },
    {
      ...
      category: "basic",
      question:
        "Write a query to drop a column named address from the employees table.",
      code: null,
      answer:
        "ALTER TABLE employees DROP COLUMN address;<br><br>This query removes the address column from the employees table.",
    },
    {
      id: 56,
      category: "basic",
    ...
    },
    {
      ...
      code: null,
      answer:
        "SELECT department_id, AVG(salary)\nFROM employees\nGROUP BY department_id;<br><br>This query calculates the average salary for each department by grouping records based on department_id.",
    },
    {
      id: 60,
      category: "joins",
    ...
    },
    {
      ...
      category: "joins",
      question:
        "Write a query to perform a CROSS JOIN between employees and departments.",
      code: null,
      answer:
        "SELECT * FROM employees CROSS JOIN departments;<br><br>This query returns all combinations of rows from the employees and departments tables.",
    },
    {
      id: 62,
      category: "advanced",
    ...
    },
    {
      ...
      code: null,
      answer:
        "SELECT name, salary, RANK() OVER (ORDER BY salary DESC) AS salary_rank<br>FROM employees;<br><br>This query ranks employees based on their salaries in descending order.",
    },
    {
      id: 67,
      category: "basic",
    ...
    },
    {
      ...
      category: "intermediate",
      question:
        "Write a query using a CTE to find employees with salaries greater than the average.",
      code: null,
      answer:
        "WITH AvgSalary AS (<br>  SELECT AVG(salary) AS avg_salary<br>  FROM employees<br>)<br>SELECT *<br>FROM employees<br>WHERE salary > (SELECT avg_salary FROM AvgSalary);<br><br>This query uses a CTE to calculate the average salary and then selects employees earning more than that average.",
    },
    {
      id: 70,
      category: "basic",
    ...
    },
    {
      ...
      category: "aggregation",
      question:
        "Write a query to find the number of employees in each department and order by the count.",
      code: null,
      answer:
        "SELECT department_id, COUNT(*) AS employee_count<br>FROM employees<br>GROUP BY department_id<br>ORDER BY employee_count DESC;<br><br>This query counts employees in each department and orders the results by the count in descending order.",
    },
    {
      id: 73,
      category: "joins",
    ...
    },
    {
      ...
      category: "joins",
      question:
        "Write a query to perform a SELF JOIN to find employees and their managers.",
      code: null,
      answer:
        "SELECT e1.name AS Employee, e2.name AS Manager<br>FROM employees e1<br>LEFT JOIN employees e2 ON e1.manager_id = e2.id;<br><br>This query retrieves a list of employees along with their corresponding managers.",
    },
    {
      id: 75,
      category: "basic",
    ...
    },
    {
      ...
      category: "basic",
      question:
        "Write a query to find employees with a salary between 30,000 and 50,000.",
      code: null,
      answer:
        "SELECT * FROM employees<br>WHERE salary BETWEEN 30000 AND 50000;<br><br>This query retrieves employees whose salaries fall within the specified range.",
    },
    {
      id: 77,
      category: "advanced",
    ...
    },
    {
      ...
      category: "advanced",
      question:
        "Write a simple stored function to calculate the annual salary.",
      code: null,
      answer:
        "CREATE FUNCTION CalculateAnnualSalary(monthly_salary DECIMAL(10,2))<br>RETURNS DECIMAL(10,2)<br>BEGIN<br>  RETURN monthly_salary * 12;<br>END;<br><br>This function takes a monthly salary and returns the annual salary.",
    },
    {
      id: 79,
      category: "advanced",
    ...
    },
    {
      ...
      code: null,
      answer:
        "EXPLAIN SELECT * FROM employees WHERE department_id = 1;<br><br>This query analyzes the execution plan for selecting employees from department 1.",
    },
  ];
  ...
  let answersVisible = false; // Track answer visibility state
  ...
  function formatSQLCode(code) {
    return code
      .replace(
        /\b(SELECT|FROM|WHERE|GROUP BY|HAVING|ORDER BY|JOIN|ON|INSERT|UPDATE|DELETE|CREATE|ALTER|DROP|TRUNCATE|UNION|ALL|AS|INTO|VALUES|TABLE|VIEW|PROCEDURE|TRIGGER|BEGIN|END)\b/gi,
  ...
  function toggleAnswer() {
    ...
    if (answerContainer) {
      ...
      answerContainer.classList.toggle("visible", answersVisible);
