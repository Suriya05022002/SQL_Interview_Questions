...
const questions = [
  ...
  },
 {
  ...
  code: null,
  answer: "SELECT * FROM employees;<br><br> This query selects and displays all columns and rows from the employees table."
},
  ...
  },
  {
    ...
    code: null,
    answer:  "SELECT MAX(salary) FROM employees; <br><br>This query returns the highest salary from the employees table."
  },
  {
    id: 8,
    category: "basic",
  ...
  code: null,
  answer: "SELECT department_id, COUNT(*) FROM employees GROUP BY department_id;<br><br>This query groups employees by department_id and counts the number of employees in each department."
},
{
  id: 13,
  category: "basic",
...
},
{
  ...
  code: null,
  answer: "SELECT department_id, COUNT(*) FROM employees GROUP BY department_id HAVING COUNT(*) > 5;<br><br>The query counts employees in each department and returns departments with more than 5 employees."
},
{
  id: 15,
  category: "basic",
...
},
{
  ...
  code: null,
  answer: "SELECT * FROM employees WHERE salary > (SELECT AVG(salary) FROM employees);<br><br>This query selects all employees with a salary higher than the average salary of all employees."
},
{
  id: 18,
  category: "joins",
...
},
{
  ...
  code: null,
  answer: "SELECT CURRENT_DATE;<br><br>This query retrieves the current date from the database."
},
{
  id: 20,
  category: "basic",
...
},
{
  ...
  code: null,
  answer: "ALTER TABLE employees ADD COLUMN email VARCHAR(255);<br><br>This query adds a new email column to the employees table."
},
{
  id: 24,
  category: "basic",
...
},
{
  ...
  code: null,
  answer: "CREATE PROCEDURE GetAllEmployees()<br>BEGIN<br>  SELECT * FROM employees;<br>END;<br><br>This procedure retrieves all records from the employees table when executed."
},
{
  id: 26,
  category: "basic",
...
},
{
  ...
  code: null,
  answer: "CREATE TRIGGER log_delete<br>AFTER DELETE ON employees<br>FOR EACH ROW<br>BEGIN<br>  INSERT INTO log_table(action, emp_id, log_time)<br>  VALUES('DELETE', OLD.id, NOW());<br>END;<br><br>This trigger logs the deletion of any employee by recording the action and employee ID in the log_table."
},
{
  id: 28,
  category: "basic",
...
},
{
  ...
  code: null,
  answer: "CREATE VIEW HighSalaryEmployees AS SELECT * FROM employees WHERE salary > 50000;<br><br>This query creates a view that shows only employees with salaries above $50,000."
},
{
  id: 30,
  category: "basic",
...
},
{
  ...
  code: null,
  answer: "SELECT department_id, SUM(salary) FROM employees GROUP BY department_id;<br><br>This query sums the salaries for each department, grouping by department_id."
},
{
  id: 33,
  category: "basic",
...
},
{
  ...
  code: null,
  answer: "SELECT DISTINCT job_title FROM employees;<br><br>This query retrieves unique job titles from the employees table."
},
{
  id: 35,
  category: "advanced",
  ...
  },
  {
    ...
    "code": null,
    "answer": "SELECT * FROM employees WHERE email IS NULL;<br><br>This query retrieves all employees whose email address is not provided (i.e., is NULL)."
  },
  {
    "id": 43,
    "category": "advanced",
  ...
  },
  {
    ...
    "code": null,
    "answer": "ALTER TABLE employees DROP COLUMN address;<br><br>This query removes the address column from the employees table."
  },
  {
    "id": 56,
    "category": "basic",
  ...
  },
  {
    ...
    "code": null,
    "answer": "SELECT * FROM employees CROSS JOIN departments;<br><br>This query returns all combinations of rows from the employees and departments tables."
  },
  {
    "id": 62,
    "category": "advanced",
  ...
  },
  {
    ...
    "code": null,
    "answer": "SELECT name, salary, RANK() OVER (ORDER BY salary DESC) AS salary_rank<br>FROM employees;<br><br>This query ranks employees based on their salaries in descending order."
  },
  {
    "id": 67,
    "category": "basic",
  ...
  },
  {
    ...
    "code": null,
    "answer": "The WITH clause defines a temporary result set (a Common Table Expression) that can be referenced within a SELECT, INSERT, UPDATE, or DELETE statement, often simplifying complex queries."
  },
  {
    "id": 69,
    "category": "intermediate",
    ...
    "code": null,
    "answer": "WITH AvgSalary AS (<br>  SELECT AVG(salary) AS avg_salary<br>  FROM employees<br>)<br>SELECT *<br>FROM employees<br>WHERE salary > (SELECT avg_salary FROM AvgSalary);<br><br>This query uses a CTE to calculate the average salary and then selects employees earning more than that average."
  },
  {
    "id": 70,
    "category": "basic",
  ...
  },
  {
    ...
    "code": null,
    "answer": "SELECT department_id, COUNT(*) AS employee_count<br>FROM employees<br>GROUP BY department_id<br>ORDER BY employee_count DESC;<br><br>This query counts employees in each department and orders the results by the count in descending order."
  },
  {
    "id": 73,
    "category": "joins",
  ...
  },
  {
    ...
    "code": null,
    "answer": "SELECT e1.name AS Employee, e2.name AS Manager<br>FROM employees e1<br>LEFT JOIN employees e2 ON e1.manager_id = e2.id;<br><br>This query retrieves a list of employees along with their corresponding managers."
  },
  {
    "id": 75,
    "category": "basic",
  ...
  },
  {
    ...
    "code": null,
    "answer": "SELECT * FROM employees<br>WHERE salary BETWEEN 30000 AND 50000;<br><br>This query retrieves employees whose salaries fall within the specified range."
  },
  {
    "id": 77,
    "category": "advanced",
  ...
  },
  {
    ...
    "code": null,
    "answer": "CREATE FUNCTION CalculateAnnualSalary(monthly_salary DECIMAL(10,2))<br>RETURNS DECIMAL(10,2)<br>BEGIN<br>  RETURN monthly_salary * 12;<br>END;<br><br>This function takes a monthly salary and returns the annual salary."
  },
  {
    "id": 79,
    "category": "advanced",
  ...
  },
  {
    ...
    "code": null,
    "answer": "EXPLAIN SELECT * FROM employees WHERE department_id = 1;<br><br>This query analyzes the execution plan for selecting employees from department 1."
  },
